"""
trainer.py — Trainer / Wrapper cho S-Learner (Criteo Uplift)
=============================================================
...
try:
    ...
    from baselines.slearner.model import SLearnerModel
...
class SLEARNER:
    ...
    def fit(
        ...
        model_name: str = "slearner",
        writer: Optional[Any] = None,
        verbose: int = 1,
    ) -> Dict[str, list]:
        """
        Huấn luyện mô hình S-Learner bằng DataLoaders truyền vào trực tiếp.
        ...
        if verbose:
            logger.info(
                f"Starting S-LEARNER training | Device: {self.device} | Epochs: {epochs}"
            )
